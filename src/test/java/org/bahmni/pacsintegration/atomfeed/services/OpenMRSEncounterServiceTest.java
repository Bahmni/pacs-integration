...
public class OpenMRSEncounterServiceTest {
    ...
    public void shouldMapOpenMRSEncounterIntoOrdersAndSave() throws Exception {
        ...
        when(openMRSEncounterToOrderMapper.map(openMRSEncounter, acceptableOrderTypes, orderRepository)).thenReturn(listOfOrders);
        ...
        verify(orderRepository, times(1)).save(listOfOrders);
    }
}