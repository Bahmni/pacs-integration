...
public class PacsIntegrationService {
    ...
    private void callNewContext(OpenMRSPatient patient,OpenMRSPatient patientCareContext) throws IOException {
        ...
        HttpPost httpPost = new HttpPost("http://10.0.2.2:9052/v0.5/hip/new-carecontext");
    ...
    private void callSmsNotify(OpenMRSPatient patient) throws IOException {

        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost("http://10.0.2.2:9052/v0.5/hip/patients/sms/notify");

        String jsonInputString = "{\"phoneNo\": \""+ patient.getPhoneNumber() + "\",\n \"receiverName\":\"" + patient.getGivenName() + "\",\n\"careContextInfo\" : \"none\"\n" + "}";
